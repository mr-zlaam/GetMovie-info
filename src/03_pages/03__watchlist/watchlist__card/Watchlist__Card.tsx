...
import "../../../07_subcomponents/01__movie__card/Movie__Card.scss";
...
import Loader from "../../../07_subcomponents/02__loader/Loader";

function WatchList__Card({ movieData }: MoviesDataProps) {
...
export default WatchList__Card;
